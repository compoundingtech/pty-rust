...
complete -c pty -n __pty_needs_command -a metadata -d 'Filesystem metadata mutations by stable id'
complete -c pty -n __pty_needs_command -a readiness -d 'Exact socket ownership and lifecycle compare-and-set'
...
complete -c pty -n '__pty_using_command run' -l startup-timeout-ms -x -d 'Daemon-owned startup deadline in milliseconds'
complete -c pty -n '__pty_using_command run' -l lifecycle-tag -x -d 'Generation-fenced lifecycle tag key'
...
complete -c pty -n '__pty_using_command events' -l type -x -d 'Print all retained events of exact type'
...
complete -c pty -n '__pty_using_command metadata' -x -a 'patch cas' -d 'Operation'
complete -c pty -n '__pty_needs_subcommand readiness' -a ownership -d 'Prove accepted socket ownership for one held connection'
complete -c pty -n '__pty_using_subcommand readiness ownership' -l id -x -d 'Exact stable session id'
complete -c pty -n '__pty_needs_subcommand readiness' -a cas -d 'Compare-and-set one lifecycle tag value'
complete -c pty -n '__pty_using_subcommand readiness cas' -l id -x -d 'Exact stable session id'
